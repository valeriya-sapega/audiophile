...
const CartModal = ({ closeModal }: CartModalProps) => {
  ...
  return (
    <div className='text-primary shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] rounded bg-white p-8 absolute mx-auto -right-6 top-24 z-10 w-[340px] sm:right-0 sm:left-auto lg:right-0'>
      {totalAmount === 0 ? (
        <div>
